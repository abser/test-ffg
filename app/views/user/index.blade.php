...
<div class="row-fluid">
    <div class="col-md-6 col-xs-12">
        ...
        <div><a href="{{ URL::route('user.create') }}" class="btn btn-default btn-raised">Add New Users</a></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-inline">
                                <li><a href="{{ URL::route('user.edit', $row->id) }}"><i class="fi-pencil">Edit</i></a></li>
                                <li>
                                    @if ($row->activated == 1)
                                    <a href="{{ URL::to('user/userdeactivate/'. $row->id,"user") }}"><i>Deactivate</i></a>
                                    @else
                                    <a href="{{ URL::to('user/useractivate/'. $row->id,"user") }}"><i>Activate</i></a>
                                    @endif
                                </li>
                            </ul>
                        </td>
