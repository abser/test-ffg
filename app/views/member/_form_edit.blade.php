...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::text('first_name',$data['member'][0]->first_name,  array('class'=>'form-control','placeholder' => 'First name','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::text('last_name', $data['member'][0]->last_name,  array('class'=>'form-control','placeholder' => 'Last name','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::email('member_email', $data['member'][0]->email,  array('class'=>'form-control','placeholder' => 'Email','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::number('member_phone',$data['member'][1]->info,  array('class'=>'form-control','placeholder' => 'Phone','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::number('member_mobile', $data['member'][2]->info,  array('class'=>'form-control','placeholder' => 'Mobile','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::text('occupation', $data['member'][0]->occupation,  array('class'=>'form-control','placeholder' => 'Occupation','required' => 'required'))}}
...
<div class="form-group">	
    ...
    <div class="col-lg-10">
        {{Form::text('member_hobbies', $data['member'][1]->interest_hobbies,  array('class'=>'form-control','placeholder' => 'Interest / Hobbies'))}}
